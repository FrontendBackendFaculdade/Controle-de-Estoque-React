...
const Estoque = () => {
    ...
    const apps = [
        { name: 'Adicionar Produto', icon: 'add-circle-outline', route: '/Paginas/AdicionarProduto' },
        { name: 'Visualizar Estoque Atual', icon: 'list-outline', route: '/Paginas/ListaProdutos' },
    ];
